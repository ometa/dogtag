...
[Български (bg)](/bg/news/2023/12/25/ruby-3-3-0-released/) [Deutsch (de)](/de/news/2023/12/25/ruby-3-3-0-released/) [English (en)](/en/news/2023/12/25/ruby-3-3-0-released/) [Español (es)](/es/news/2023/12/25/ruby-3-3-0-released/) [Français (fr)](/fr/news/2023/12/25/ruby-3-3-0-released/) [Indonesia (id)](/id/news/2023/12/25/ruby-3-3-0-released/) [Italiano (it)](/it/news/2023/12/25/ruby-3-3-0-released/) [日本語 (ja)](/ja/news/2023/12/25/ruby-3-3-0-released/) [한국어 (ko)](/ko/news/2023/12/25/ruby-3-3-0-released/) [polski (pl)](/pl/news/2023/12/25/ruby-3-3-0-released/) [Português (pt)](/pt/news/2023/12/25/ruby-3-3-0-released/) [Русский (ru)](/ru/news/2023/12/25/ruby-3-3-0-released/) [Türkçe (tr)](/tr/news/2023/12/25/ruby-3-3-0-released/) [Українська (uk)](/uk/news/2023/12/25/ruby-3-3-0-released/) [Tiếng Việt (vi)](/vi/news/2023/12/25/ruby-3-3-0-released/) [简体中文 (zh\_cn)](/zh_cn/news/2023/12/25/ruby-3-3-0-released/) [繁體中文 (zh\_tw)](/zh_tw/news/2023/12/25/ruby-3-3-0-released/)
...
*   Major performance improvements over Ruby 3.2
    ...
    *   Basic methods like Rails `#blank?` and [specialized `#present?`](https://github.com/rails/rails/pull/49909) are inlined.
...
*   Code GC is now disabled by default
    ...
    *   No sudden drops in performance due to code GC. Better copy-on-write behavior on servers reforking with [Pitchfork](https://github.com/shopify/pitchfork).
    *   You can still enable code GC if desired with `--yjit-code-gc`
*   Add `RubyVM::YJIT.enable` that can enable YJIT at run-time
    *   You can start YJIT without modifying command-line arguments or environment variables. Rails 7.2 will [enable YJIT by default](https://github.com/rails/rails/pull/49947) using this method.
...
*   Several performance improvements to the Garbage Collector
    *   Young objects referenced by old objects are no longer immediately promoted to the old generation. This significantly reduces the frequency of major GC collections. [\[Feature #19678\]](https://bugs.ruby-lang.org/issues/19678)
    *   A new `REMEMBERED_WB_UNPROTECTED_OBJECTS_LIMIT_RATIO` tuning variable was introduced to control the number of unprotected objects cause a major GC collection to trigger. The default is set to `0.01` (1%). This significantly reduces the frequency of major GC collection. [\[Feature #19571\]](https://bugs.ruby-lang.org/issues/19571)
...
*   `Regexp::new` now only accepts up to 2 arguments instead of 3. This was deprecated in Ruby 3.2. [\[Bug #18797\]](https://bugs.ruby-lang.org/issues/18797)
...
See [NEWS](https://github.com/ruby/ruby/blob/v3_3_0/NEWS.md) or [commit logs](https://github.com/ruby/ruby/compare/v3_2_0...v3_3_0) for more details.

With those changes, [5532 files changed, 326851 insertions(+), 185793 deletions(-)](https://github.com/ruby/ruby/compare/v3_2_0...v3_3_0#file_bucket) since Ruby 3.2.0!
...
*   [https://cache.ruby-lang.org/pub/ruby/3.3/ruby-3.3.0.tar.gz](https://cache.ruby-lang.org/pub/ruby/3.3/ruby-3.3.0.tar.gz)
...
*   [https://cache.ruby-lang.org/pub/ruby/3.3/ruby-3.3.0.tar.xz](https://cache.ruby-lang.org/pub/ruby/3.3/ruby-3.3.0.tar.xz)
...
*   [https://cache.ruby-lang.org/pub/ruby/3.3/ruby-3.3.0.zip](https://cache.ruby-lang.org/pub/ruby/3.3/ruby-3.3.0.zip)
